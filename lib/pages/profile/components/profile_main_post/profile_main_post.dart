...
class ProfileMainPost extends StatefulWidget {
  final int id;
  ...
  _ProfileMainPostState createState() => _ProfileMainPostState();
...
class _ProfileMainPostState extends State<ProfileMainPost> {
