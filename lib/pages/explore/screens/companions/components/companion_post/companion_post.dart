...
class CompanionsPost extends StatefulWidget {
  final int id;
  ...
  _CompanionsPostState createState() => _CompanionsPostState();

  const CompanionsPost({
    Key? key,
    required this.id,
...
class _CompanionsPostState extends State<CompanionsPost> {
