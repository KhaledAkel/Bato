...
class OtherProfileMainPost extends StatefulWidget {
  final int id;
  ...
  _OtherProfileMainPostState createState() => _OtherProfileMainPostState();

  const OtherProfileMainPost({
    Key? key,
    required this.id,
...
class _OtherProfileMainPostState extends State<OtherProfileMainPost> {
